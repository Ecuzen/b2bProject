                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        ...
                        <div class="mb-3 row" id="dateDiv">
                           <label class="col-lg-3 col-form-label datepicker" for="validationCustom03">Wallet Amount</label>
                           <div class="col-lg-3">
                              <input type="text" class="form-control" id="wallet"  required readonly="">
                           </div>
                           <label class="col-lg-3 col-form-label datepicker" for="validationCustom03">Lock Amount</label>
                           <div class="col-lg-3">
                              <input type="text" class="form-control" id="lockAmount" required >
                           </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-lg-4"></div>
                           <div class="col-lg-4">
                              <button type="button" class="btn btn-primary lockAmount">Lock Amount</button>
                           </div>
                        </div>
                     </div>
                  </div>
...
<script>
    ...
    $("#user").on('change',function(){
        ...
        $.each(allUser, function (index, allUser) {
            ...
            {
                wallet = allUser.wallet;
                $("#wallet").val(allUser.wallet);
            }
        });
    })
