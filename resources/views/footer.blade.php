    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
      <nav class="sidebar-nav scroll-sidebar">
        <div class="offcanvas-header justify-content-between">
          <img src="{{url('assets')}}/dist/images/logos/favicon.png" alt="" class="img-fluid">
...
function success(text)
{
  ...
  <!--  Customizer -->
    ...
    <script src="{{url('assets')}}/dist/libs/owl.carousel/dist/owl.carousel.min.js"></script>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2023 12:35:54 GMT -->
</html>