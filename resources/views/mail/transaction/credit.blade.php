...
<html>
<head>
  <title>Transaction Credit Notification</title>
  <style>
    body {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <h1>Transaction Credit Notification</h1>
    </div>
    
    <div class="content">
      <p>Dear {{$data['name']}},</p>
      <p>This email is to inform you that a credit transaction has been made to your account.</p>
      <p>Transaction details:</p>
      <ul>
        <li>Date: {{$data['date']}}</li>
        <li>Amount: {{$data['amount']}}</li>
        <li>Txn Id: {{$data['txnid']}}</li>
