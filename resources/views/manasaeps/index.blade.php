                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="validationCustom01"> </label>
                                                    <div class="col-lg-8">
                                                        <button class="form-control transaction-tfa btn btn-primary" type="button">Two Factor Varification</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
$(document).on("click", ".transaction-tfa", function () {
    ...
    var data = {'_token':'{{csrf_token()}}','isFor' : true,'lat' : $("#latitude").val(),'log': $("#longitude").val()};
    captureFinger(url, data);
});
