...
<!-- Mirrored from zenix.dexignzone.com/laravel/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 09:24:01 GMT -->
...
<head>
    ...
    <meta name="csrf-token" content="o4NoTHJfm5zInjPay6ujUFkUPkGVkjTMk9oeehXi">
    ...
    <!-- Favicon icon -->
  <!--  <link rel="icon" type="image/png" sizes="16x16" href="{{url('assets')}}/public/images/favicon.png">-->
    <link rel="icon" type="image/png" sizes="16x16" href="https://ecuzen.com/assets/icon.png">
    
         
                    <link href="{{url('assets')}}/public/vendor/chartist/css/chartist.min.css" rel="stylesheet" type="text/css"/>
                    <link href="{{url('assets')}}/public/vendor/owl-carousel/owl.carousel.css" rel="stylesheet" type="text/css"/>
                    <link href="{{url('assets')}}/public/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet" type="text/css"/>
                    <link href="{{url('assets')}}/public/css/style.css" rel="stylesheet" type="text/css"/>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/kyc" class="brand-logo">
                 <div class="logo-abbr">
                    <img src="https://ecuzen.com/assets/icon.png" style="width:100%; height:100%">
                </div>
                <div class="brand-title">
                    <img src="https://ecuzen.com/assets/logo.png" style="width:100%; height:100%">
                </div>
            </a>
						...
						<ul class="contacts">
							...
							<li class="active dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="{{url('assets')}}/public/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="{{url('assets')}}/public/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="{{url('assets')}}/public/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="{{url('assets')}}/public/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="{{url('assets')}}/public/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
					...
					<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
								<img src="{{url('assets')}}/public/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
							</div>
						...
						<div class="d-flex justify-content-end mb-4">
							...
							<div class="img_cont_msg">
						<img src="{{url('assets')}}/public/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
							</div>
						</div>
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
                ...
                <ul class="navbar-nav header-right main-notification">
									...
									<li>
										<div class="timeline-panel">
											<div class="media me-2">
												<img alt="image" width="50" src="{{url('assets')}}/public/images/avatar/1.jpg">
											</div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="{{url('assets')}}/public/images/profile/pic1.jpg" width="20" alt=""/>
...
<div class="deznav">
    <div class="deznav-scroll">
		<div class="main-profile">
			<div class="image-bx">
				<img src="{{url('assets')}}/public/images/Untitled-1.jpg" alt="">
				<a href="javascript:void(0);"><i class="fa fa-cog" aria-hidden="true"></i></a>
			</div>
			<h5 class="name"><span class="font-w400">Hello,</span> Vinay </h5>
			<p class="email">vinay@ecuzen.com</p>
		</div>
                		...
                		<div class="row page-titles mx-0">
                            <div class="col-sm-6 p-md-0">
                                <div class="welcome-text">
                                    <h4>Hi, welcome Ecuzen Software!</h4>
                            ...
                            <div class="col-xl-8 mx-auto">
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                        <h1 class="card-title mx-auto text-danger" style="font-size:40px; font-weight:900">Pending Kyc</h1>
                                    </div>
                                    <div class="card-body text-center">
                                        <h6 class="card-text mx-auto">Your Kyc Request Is Pending . So Please wait For Admin To Approve Your Kyc.</h6>
                                        <h6 class="card-text mx-auto">Admin Mobile : 8696921014</h6>
                                        <h6 class="card-text mx-auto">Admin Email : vinay@ecuzen.com</h6>
                                    </div>
...
***********************************-->		
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
	<script src="{{url('assets')}}/public/vendor/global/global.min.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/vendor/bootstrap-select/dist/js/bootstrap-select.min.js" type="text/javascript"></script>
					<script src="{{url('assets')}}/public/vendor/chart.js/Chart.bundle.min.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/vendor/peity/jquery.peity.min.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/vendor/apexchart/apexchart.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/vendor/owl-carousel/owl.carousel.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/js/dashboard/dashboard-1.js" type="text/javascript"></script>
					<script src="{{url('assets')}}/public/js/custom.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/js/deznav-init.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/js/demo.js" type="text/javascript"></script>
				<script src="{{url('assets')}}/public/js/styleSwitcher.js" type="text/javascript"></script>
	    </body>

<!-- Mirrored from zenix.dexignzone.com/laravel/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 09:24:34 GMT -->
</html>
