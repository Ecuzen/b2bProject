  ...
  <div class="container">
    ...
    <div class="info">
      ...
      @php
        $i = 1;
      @endphp
      @foreach($paramdetails as $param)
        <p><strong>{{$param['name']}}:</strong> {{$param['value']}}</p>
        <input type="hidden" value="{{$param['value']}}" id="param{{$i++}}">
      @endforeach
    </div>
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <input type="hidden" class="amount" value="{{$item3value}}" id="amount">
          <input type="hidden" class="skey" value="{{$skey}}" id="skey">
        </tr>
      </tbody>
    </table>
