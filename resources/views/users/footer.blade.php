        ...
        <ul class="mb-0">
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{url('assets')}}/dist/images/products/product-1.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{url('assets')}}/dist/images/products/product-2.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{url('assets')}}/dist/images/products/product-3.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
      <nav class="sidebar-nav scroll-sidebar">
        <div class="offcanvas-header justify-content-between">
          <img src="{{url('assets')}}/images/bg-remove-logo.png" alt="" class="img-fluid" style="width:50px;height:40px;">
    ...
    <div class="offcanvas-body p-4">
      <div class="theme-option pb-4">
        ...
        <div class="d-flex align-items-center gap-3 my-3">
          <a href="javascript:void(0)"  onclick="toggleTheme('{{url('assets')}}/dist/css/style.min.css')"  class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
            <i class="ti ti-brightness-up fs-7 text-primary"></i>
            <span class="text-dark">Light</span>
          </a>
          <a href="javascript:void(0)" onclick="toggleTheme('{{url('assets')}}/dist/css/style-dark.min.css')" class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 dark-theme text-dark">
        ...
        <div class="d-flex align-items-center gap-3 my-3">
          <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)" class="rounded-circle position-relative d-block customizer-bgcolor skin1-bluetheme-primary active-theme " onclick="toggleTheme('{{url('assets')}}/dist/css/style.min.css')"  data-color="blue_theme" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="BLUE_THEME"><i class="ti ti-check text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)"  class="rounded-circle position-relative d-block customizer-bgcolor skin2-aquatheme-primary " onclick="toggleTheme('{{url('assets')}}/dist/css/style-aqua.min.css')"  data-color="aqua_theme" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="AQUA_THEME"><i class="ti ti-check  text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)" class="rounded-circle position-relative d-block customizer-bgcolor skin3-purpletheme-primary" onclick="toggleTheme('{{url('assets')}}/dist/css/style-purple.min.css')"  data-color="purple_theme" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="PURPLE_THEME"><i class="ti ti-check  text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)" class="rounded-circle position-relative d-block customizer-bgcolor skin4-greentheme-primary" onclick="toggleTheme('{{url('assets')}}/dist/css/style-green.min.css')"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="GREEN_THEME"><i class="ti ti-check  text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)" class="rounded-circle position-relative d-block customizer-bgcolor skin5-cyantheme-primary" onclick="toggleTheme('{{url('assets')}}/dist/css/style-cyan.min.css')"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="CYAN_THEME"><i class="ti ti-check  text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
            <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
              <a href="javascript:void(0)" class="rounded-circle position-relative d-block customizer-bgcolor skin6-orangetheme-primary" onclick="toggleTheme('{{url('assets')}}/dist/css/style-orange.min.css')"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="ORANGE_THEME"><i class="ti ti-check  text-white d-flex align-items-center justify-content-center fs-5"></i></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="modal fade" id="otp-pin-modal" data-bs-backdrop="static"  data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h5 class="pin-modal-title modal-title">Transfer Money</h5>
            </div>
            <div id="transfer-modal">
                <div class="pin-otp-modal-body modal-body">
  ...
  <!--Fields are only for finger print-->
<input type="hidden" name="new" id="method" class="form-control">
<input type="hidden" name="hdnDevice" id="hdnDevice" class="form-control">
    <!--<script src="{{ url('assets') }}/public/js/kyc1.js?v=1.0.5"></script>-->
    <!--<script src="{{ url('assets') }}/public/js/custom1.js?v=1.0.4"></script>-->
    <script>
  ...
  function enableBody() {
    ...
    $('.spinner').remove();
      ...
      function error(text)
        ...
        function txnsuccessNew(text,view)
        {
            Swal.fire({
              position: 'center',
              icon: 'success',
        ...
        function otpviewNew(view)
        {
            $("#otp-pin-modal").modal("show");
            $(".pin-modal-title").html('Please enter 4-digit PIN')
            $(".pin-otp-modal-body").html(view);
        }
        function jumpToNext(currentInput, nextInputId) {
        ...
        function handleBackspace(currentIndex) {
            if (event.keyCode === 8 && event.target.value === '') {
                ...
                if (previousIndex >= 1) {
                    var previousInput = document.getElementById('digit' + previousIndex);
                    previousInput.focus();
                }
            }
        }
        function shortmessagesuccess(title)
{
    Swal.fire({
      position: 'top-end',
      icon: 'success',
...
function shortmessageerror(title)
{
    Swal.fire({
      position: 'top-end',
      icon: 'error',
...
function shortmessageinfo(title)
{
    Swal.fire({
      position: 'top-end',
      icon: 'info',
...
function showError(error) {
    switch (error.code) {
        case error.PERMISSION_DENIED:
            $('body').html('<p style="justify-content: center;display: flex;align-items: center;height: 100vh;">Location Permission is required</p>');
            break;
...
getLocation();
    ...
    <script src="{{url('assets')}}/dist/js/forms/form-wizard.js?v=1.1.9"></script>
    <script src="https://cdn.rawgit.com/davidshimjs/qrcodejs/gh-pages/qrcode.min.js"></script>
    @if(Request::is('/dashboard'))
    <script src="{{url('assets')}}/chart/realtime.js?v=1.2.1"></script>
    @endif
    <script src="{{ url('assets') }}/public/js/kyc.js?v=1.7.8"></script>
    <script>
        $(document).ready(function(){
            $("#viewextraServices").click(function(){
                $("#extraServices").slideToggle(); // Toggle the display of #extraServices
            });
        });
    </script>
...
<input type="hidden"  id="ddlAVDM" >
<!--<input type="hidden"  id="txtWadh" >-->
<input type="hidden" name="txtWadh" id="txtWadh" value="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=">
